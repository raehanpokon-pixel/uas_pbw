    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-foto">
                        <img src="<?php echo e(asset('storage/' . $p->foto)); ?>" alt="<?php echo e($p->nama_produk); ?>" class="product-image">
                    </td>

                    <td><?php echo e($p->nama_produk); ?></td>

                    <td><span class="col-gender"><?php echo e($p->kategori->gender); ?></span></td>
                    ...
                    <td>
                        ...
                        <form action="<?php echo e(route('Admin.destroy', $p->id)); ?>"
                              method="POST"
...
<?php /**PATH D:\uaspbw\resources\views/Admin/index.blade.php ENDPATH**/ ?>