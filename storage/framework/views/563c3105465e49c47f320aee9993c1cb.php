...
<div class="container">
    ...
    <!-- LEFT -->
    <div>
        <h1 style="font-size:26px; margin-bottom:20px;"><?php echo e($produk->nama_produk); ?></h1>
        ...
        <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <input type="radio" id="size<?php echo e($s); ?>" name="size">
            <label class="size-label" for="size<?php echo e($s); ?>"><?php echo e($s); ?></label>
    ...
    <div>
        <div class="summary-box">
            ...
            <table>
                <tr>
                    <td>Subtotal</td>
                    <td style="text-align:right;">Rp <?php echo e(number_format($subtotal,0,',','.')); ?></td>
                </tr>
                <tr>
                    <td>Pengiriman</td>
...
<?php /**PATH D:\uaspbw\resources\views/transaksi.blade.php ENDPATH**/ ?>