...
<head>
    ...
    <!-- Memakai Tailwind CSS dari CDN untuk testing -->
...
<body class="bg-white">
    ...
    <header class="relative w-full h-[450px] md:h-[500px]">
        <!-- ... (konten header) ... -->
        <img src="<?php echo e(asset('storage/home/banner.jpg')); ?>">
    ...
    <main class="container mx-auto px-4 mt-8">
        ...
        <!-- 2. Grid Promosi Pertama (Collage) -->
        <section class="grid grid-cols-2 md:grid-cols-4 grid-rows-2 gap-4 h-[600px] md:h-[500px]">
            ...
            <div class="col-span-1 row-span-2 rounded-lg overflow-hidden">
                <img src="<?php echo e($promoGrid1['boots']['image_url'] ?? 'https://via.placeholder.com/300x600.png?text=Boots'); ?>" 
                     alt="Boots" class="w-full h-full object-cover">
            </div>
            <div class="col-span-1 md:col-span-2 row-span-1 rounded-lg overflow-hidden">
                <img src="<?php echo e($promoGrid1['arrived']['image_url'] ?? 'https://via.placeholder.com/600x300.png?text=Arrived'); ?>" 
            ...
            <div class="col-span-1 row-span-1 flex flex-col gap-4">
                <div class="flex-1 rounded-lg overflow-hidden">
                    <img src="<?php echo e($promoGrid1['coupon1']['image_url'] ?? 'https://via.placeholder.com/300x140.png?text=Coupon+1'); ?>" 
                         alt="Coupon 1" class="w-full h-full object-cover">
                </div>
                <div class="flex-1 rounded-lg overflow-hidden">
                     <img src="<?php echo e($promoGrid1['coupon2']['image_url'] ?? 'https://via.placeholder.com/300x140.png?text=Coupon+2'); ?>" 
                         alt="Coupon 2" class="w-full h-full object-cover">
                </div>
            </div>
            <div class="col-span-1 md:col-span-2 row-span-1 rounded-lg overflow-hidden">
                <img src="<?php echo e($promoGrid1['sale']['image_url'] ?? 'https://via.placeholder.com/600x300.png?text=70%25+OFF'); ?>" 
                     alt="Sale" class="w-full h-full object-cover">
            </div>
            <div class="col-span-1 row-span-1 rounded-lg overflow-hidden">
                <img src="<?php echo e($promoGrid1['style']['image_url'] ?? 'https://via.placeholder.com/300x300.png?text=Make+Style'); ?>" 
                     alt="Make Your Style" class="w-full h-full object-cover">
            </div>
        </section>

        <!-- 3. Grid Promosi Kedua (Fairytale & Dunk) -->
        <section class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            ...
            <div class="md:col-span-2 relative rounded-lg overflow-hidden h-[500px] md:h-auto">
                <img src="<?php echo e($promoGrid2['heels']['image_url'] ?? 'https://via.placeholder.com/600x600.png?text=Heels'); ?>" 
                     alt="Heels" class="w-full h-full object-cover">
                <div class="absolute bottom-10 left-10 text-gray-800">
                    <h3 class="text-2xl font-serif italic"><?php echo e($promoGrid2['heels']['title'] ?? 'Step into your fairytale'); ?></h3>
                    <p class="text-lg font-serif"><?php echo e($promoGrid2['heels']['subtitle'] ?? 'Every step is a whisper of elegance'); ?></p>
                </div>
            </div>
            <div class="md:col-span-1 flex flex-col gap-4">
                <div class="rounded-lg overflow-hidden">
                    <img src="<?php echo e($promoGrid2['flats']['image_url'] ?? 'https://via.placeholder.com/400x250.png?text=Flats'); ?>" 
                         alt="Flats" class="w-full h-full object-cover">
                </div>
                <div class="rounded-lg overflow-hidden">
                    <img src="<?php echo e($promoGrid2['white_heels']['image_url'] ?? 'https://via.placeholder.com/400x250.png?text=White+Heels'); ?>" 
                         alt="White Heels" class="w-full h-full object-cover">
                </div>
                <div class="rounded-lg overflow-hidden">
                    <img src="<?php echo e($promoGrid2['dunk']['image_url'] ?? 'https://via.placeholder.com/400x300.png?text=Dunk+Poster'); ?>" 
                         alt="Dunk Poster" class="w-full h-full object-cover">
                </div>
            </div>
        </section>

        <!-- 4. Best Seller (Bagian yang error) -->
        <section class="mt-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div class="border border-gray-200 rounded-lg shadow-md overflow-hidden bg-gray-50">
                    ...
                    <div class="bg-gray-200 h-64">
                        <img src="<?php echo e($product->image_url ?? 'https://via.placeholder.com/400x300.png?text=Product'); ?>" 
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center my-2">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <svg class="w-5 h-5 <?php echo e($i <= $product->rating ? 'text-yellow-400' : 'text-gray-300'); ?>" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="#" class="w-full text-center block bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition">
                            Buy
                        </a>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="col-span-3 text-center text-gray-500">Produk best seller belum tersedia.</p>
...
</html><?php /**PATH D:\uaspbw\resources\views/home.blade.php ENDPATH**/ ?>